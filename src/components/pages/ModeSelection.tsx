...
export default function ModeSelection() {
    ...
    const handleStartGame = () => {
        ...
        const continentParam = selectedContinents.length === 0 || selectedContinents.length === CONTINENTS.length
            ? "all"
                    ...
                    <div className="mb-6 sm:mb-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div className="space-y-2 sm:space-y-3">
                                ...
                                {isAuthenticated && (
                                    <button
                                        onClick={() => setSelectedMode("GCFF_TRAINING_INFINITE")}
                            ...
                            <div className="space-y-2 sm:space-y-3">
                                ...
                                {isAuthenticated && (
                                    <button
                                        onClick={() => setSelectedMode("GCFC_TRAINING_INFINITE")}
                                        className={`w-full p-3 sm:p-4 rounded-xl border-2 transition-all ${
